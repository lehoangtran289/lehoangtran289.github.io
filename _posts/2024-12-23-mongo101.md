...
Adds or modifies fields in pipeline.
...
Counts the total number of documents in the pipeline.
...
Allows you to specify a durability guarantee for the documents returned by a read operation. It adjusts the level of consistency and availability, you can choose between returning the most recent data to the cluster, or data committed by a majority of members.
